...
#
# Commands:
#   hubot ayuda - Muestra todos los comandos de ayuda conocidos.
#   hubot ayuda <query> - Muestra la ayuda sobre el comando elegido <query>.
#
# URLS:
#   /hubot/help
#
...
module.exports = (robot) ->
  ...
  robot.respond /ayuda(?:\s+(.*))?$/i, (msg) ->
    ...
    if filter
      ...
      if cmds.length is 0
        msg.send "No es valido el comando ingresado #{filter}"
        return
